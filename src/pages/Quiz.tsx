...
const Quiz = () => {
  ...
  const quizOneTooltips: TooltipInfo[] = [
    ...
    },
    {
      ...
      arrowPosition: { bottom: "-30px", left: "20px", transform: "rotate(-90deg)" } // Changed from top to bottom and rotated
    },
    {
      id: "lives",
      title: "Lives",
      ...
      arrowPosition: { bottom: "-30px", right: "20px", transform: "rotate(90deg)" } // Changed from top to bottom and rotated
    }
  ];
